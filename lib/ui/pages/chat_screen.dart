            ...
            new Container(
              padding: const EdgeInsets.only(left: 8.0),
                child: new Column(
                  ...
                  children: <Widget>[
                    new Center(
                      child: new Text(widget.name, style: Theme.of(context).textTheme.headline6,),
                    ),
                    new Text("last seen. 18:00", style: new TextStyle(fontSize: 13.0, color: Color.fromARGB(255, 28, 27, 27), fontStyle: FontStyle.italic),),
                  ],
                ),
            ),
          ],
